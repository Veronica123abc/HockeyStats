...
class HockeyGui(hockey_gui_handler.HockeyGuiHandler):
    ...
    def __init__(self, **kwargs):
        ...
        scrollbar_t1.grid(row=0, column=1,sticky="NS")
        ...
        scrollbar_t2.grid(row=1, column=1,sticky="NS")
        self.players_t2_listbox = Listbox(self.right_frame, width=35, height=22, yscrollcommand = scrollbar_t2.set,
                                    exportselection=0,
                                    relief=SUNKEN,
                                    bg='gray')
        self.players_t1_listbox.grid(row=0, column=0, sticky="N")
        self.players_t2_listbox.grid(row=1, column=0, sticky="N")
        ...
        self.clean_image = cv2.imread("/home/veronica/repos/HockeyStats/static/images/rink.jpg")
        ...
        self.entries_slider = Scale(self.entries_frame, orient="horizontal",
                                 from_=0, to=10, length=300, command=self.slider_frame_action)
